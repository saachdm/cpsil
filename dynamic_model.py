...
class dynMod_simpletwowheelLong:
    """
    Longitudinal simple two wheel model. The parameters are still arbitrary
    and some initial values are hardcoded. The RK4 integration part was written
    by chatGPT for practicality reasons :)
    ...
    F_x():
        Calculate the longitudinal force based on slip.
    Fz():
